        ...
        {order && (
          <>
            <Descriptions bordered column={2}>
              ...
              <Descriptions.Item label="Người nhận">{order.userResponse?.name || '—'}</Descriptions.Item>
              <Descriptions.Item label="Email">{order.userResponse?.email || '—'}</Descriptions.Item>
              <Descriptions.Item label="Số điện thoại">{order.userResponse?.phone || '—'}</Descriptions.Item>
              <Descriptions.Item label="Địa chỉ" span={2}>{order.userResponse?.address || '—'}</Descriptions.Item>
